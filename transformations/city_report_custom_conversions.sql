-- city_report_custom_conversions
{% assign target_dataset = vars.target_dataset_id %}
{% assign target_table_id = 'city_report_custom_conversions' %}
{% assign source_dataset = vars.source_dataset_id %}
{% assign source_table_id = 'stream_city_report_custom_conversions' %}
...
SELECT
  TO_HEX(SHA256(CONCAT(
    ...
    COALESCE(segments__geoTargetCity, ''),
  ...
  geographicView__countryCriterionId AS country_criterion_id,
  geographicView__locationType AS location_type,
  geographicView__resourceName AS resource_name,
  segments__conversionActionName AS conversion_action_name,
  segments__geoTargetCity AS geo_target_city,
