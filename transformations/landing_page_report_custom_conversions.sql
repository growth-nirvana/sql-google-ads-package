...
{% assign target_table_id = 'landing_page_report_custom_conversions' %}

{% assign source_dataset = vars.source_dataset_id %}
{% assign source_table_id = 'stream_landing_page_report_custom_conversions' %}
{% assign drop_source_table = vars.drop_source_table | default: false %}

{% if vars.models.switchover_landing_page_report_custom_conversions.active == false %}
select 1
{% else %}
...
BEGIN TRANSACTION;
  ...
  SELECT 
    ...
    DATE(segments__date),
    landingPageView__unexpandedFinalUrl,
    ...
    TO_HEX(SHA256(CONCAT(
      ...
      COALESCE(landingPageView__unexpandedFinalUrl, ''),
