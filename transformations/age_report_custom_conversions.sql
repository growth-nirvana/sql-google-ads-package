...
{% assign target_table_id = 'age_report_custom_conversions' %}
{% assign source_dataset = vars.source_dataset_id %}
{% assign source_table_id = 'stream_age_report_custom_conversions' %}
...
SELECT
  ...
  adGroupCriterion__ageRange__type AS age_range_type,
