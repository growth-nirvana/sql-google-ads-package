...
This table provides custom conversion metrics for Google Ads by demo region, supporting granular analysis of conversion actions by region and date. It is updated incrementally with each ETL run.
