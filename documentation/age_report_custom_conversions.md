# age_report_custom_conversions

This table provides custom conversion metrics for Google Ads by age segment, supporting granular analysis of conversion actions by age range and date. It is updated incrementally with each ETL run.
...
The table uses a hash-based change detection mechanism (`_gn_id`) that includes key age, group, campaign, and date attributes.

## Usage

- **Age-based conversion analysis:** Analyze metrics by age range, group, campaign, and date
