...
This table provides custom conversion metrics for Google Ads by gender segment, supporting granular analysis of conversion actions by gender and date. It is updated incrementally with each ETL run.
...
The table uses a hash-based change detection mechanism (`_gn_id`) that includes key gender, group, campaign, and date attributes.

## Usage

- **Gender-based conversion analysis:** Analyze metrics by gender, group, campaign, and date
